    ...
    <body>
        ...
        <header id="topnav">
            <div class="topbar-main">
                <div class="container">
                    ...
                    <!-- Logo container-->
                    <div class="logo">
                        <a href="{{ route('dashboard') }}" class="logo"><img src="{{asset('assets/images/logo_sm.png')}}" height="50px" style="border-radius: 5px"></a>
                    </div>
                    <!-- End Logo container-->
                ...
                <div id="navigation">
                    ...
                    <ul class="navigation-menu">
                        ...
                        <li class="has-submenu">
                            <a href="#"> <i class="{{$m->modulo->icono}}"></i>{{ $m->modulo->nombre }}</a>
                            <ul class="submenu">
        ...
        <div class="wrapper">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h2 class="page-title" style="background-color: #0b2037; color: white; padding: 5px 15px; margin-bottom: 3px;">@yield('title')</h2>
                        <div class="ribbon" style="background: #83020E; padding: 5px; margin-bottom: 10px"></div>
                    </div>
                </div>
                <!-- Page-Title -->
                ...
                <footer class="footer text-right">
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12">
                                2016 © Agencia de Seguros y Fianzas M&amp;C, SA
                            </div>
                        </div>
                    </div>
                </footer>
