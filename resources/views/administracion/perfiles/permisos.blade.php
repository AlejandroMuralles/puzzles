...
@section('title') Permisos - $perfil->nombre @stop

@section('header') Permisos - $perfil->nombre @stop
...
<div class="row">
    <div class="col-lg-12">
        <div class="card-box">
            {!! Form::open(['route' => array('permisos', $perfil->id), 'method' => 'POST', 'id' => 'form', 'class' => 'validate-form']) !!}
				<div class="row">
					<div class="col-lg-12">
						<div class="row">
							<div class="col-lg-3">
